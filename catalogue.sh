...
cp /tmp/roboshop-shell/catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
mongo --host mongodb.glitztechs.online </app/schema/catalogue.js &>>$LOGFILE
